...
@Api(value = "字典类型表")
@Controller
@RequestMapping("/CreateDataController")
public class CreateDataController extends BaseController {

    private String prefix = "admin/create_data";
    @Autowired
    ...
    public String view(ModelMap model, String systemCode) {
        String str = "挡板表";
    ...
    @RequiresPermissions("db:pft:view")
    @ResponseBody
    public Object list(Tablepar tablepar, String searchText, String systemCode) {
        PageInfo<TPBaffleDataMethodInfo> page = baffleDataMethodService.list(tablepar, searchText, systemCode);
        TableSplitResult<TPBaffleDataMethodInfo> result = new TableSplitResult<>(page.getPageNum(), page.getTotal(), page.getList());
        return result;
    }
...
//
    ...
    public String edit(@PathVariable("id") String id, ModelMap mmap) {
        mmap.put("baffleData", baffleDataMethodService.selectByPrimaryKey(id));
        return prefix + "/edit";
    }
    ...
    @PostMapping("/edit")
    @ResponseBody
    public AjaxResult editSave(TPBaffleDataMethodInfo record) {
        return toAjax(baffleDataMethodService.updateByPrimaryKeySelective(record));
    }
