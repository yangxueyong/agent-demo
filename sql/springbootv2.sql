...
VALUES('682782768429666304', '挡板管理', '', NULL, 0, '1', NULL, 0, 'fa fa-balance-scale', 1, 0);
INSERT INTO t_sys_permission
(id, name, descripion, url, is_blank, pid, perms, `type`, icon, order_num, visible)
VALUES('682783462243045376', '测试造数', '', '/CreateDataController/view?systemCode=pft', 0, '682782768429666304', 'db:pft:view', 1, '', NULL, 0);
...
VALUES('8a803b12-91c5-40fd-a571-6518e11d1b0c', '682783526478811136', '1');
INSERT INTO t_sys_permission_role
(id, role_id, permission_id)
VALUES('bc44f811-0c18-4d4d-95c0-4536c90e5946', '682783526478811136', '682782768429666304');
INSERT INTO t_sys_permission_role
(id, role_id, permission_id)
VALUES('cf4f3b34-62ad-4a6f-9968-12921d7cac88', '682783526478811136', '682783462243045376');
...
INSERT INTO t_sys_role_user (id, sys_user_id, sys_role_id) VALUES('682785544266190848', '682780866673512448', '488289006124007424');
INSERT INTO t_sys_role_user (id, sys_user_id, sys_role_id) VALUES('682785544270385152', '682780866673512448', '488305788310257664');
INSERT INTO t_sys_role_user (id, sys_user_id, sys_role_id) VALUES('682785544274579456', '682780866673512448', '682783526478811136');
...
VALUES('682780866673512448', 'create_data_user', 'aa7b566fa39879a0a434b79a65ac4710', '创建数据的用户');
...
CREATE TABLE `t_p_baffle_data_detail_info` (
    `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
    `method_id` bigint DEFAULT NULL COMMENT '外键',
    `user_no` varchar(100) DEFAULT NULL COMMENT '用户编号',
    `in_param` varchar(4000) DEFAULT NULL COMMENT '入参',
    `out_param` longtext COMMENT '出参',
    `status` int DEFAULT NULL COMMENT '1 可用 0 不可用',
    `create_user_no` varchar(100) DEFAULT NULL COMMENT '创建人',
    `create_time` datetime DEFAULT NULL COMMENT '创建时间',
    `maintenance_user_no` varchar(100) DEFAULT NULL COMMENT '修改人',
    `maintenance_time` datetime DEFAULT NULL COMMENT '修改时间',
    `remark` varchar(500) DEFAULT NULL COMMENT '备注',
     PRIMARY KEY (`id`)
) ;


-- springbootv2.t_p_baffle_data_method_info definition

CREATE TABLE `t_p_baffle_data_method_info` (
    `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
    `method_name` varchar(500) DEFAULT NULL COMMENT '方法名',
    `system_code` varchar(100) DEFAULT NULL COMMENT '系统编号',
    `create_user_no` varchar(100) DEFAULT NULL COMMENT '创建人',
    `create_time` datetime DEFAULT NULL COMMENT '创建时间',
    `maintenance_user_no` varchar(100) DEFAULT NULL COMMENT '修改人',
    `maintenance_time` datetime DEFAULT NULL COMMENT '修改时间',
    `method_china_name` varchar(200) DEFAULT NULL COMMENT '方法中文名',
    `status` int DEFAULT '0' COMMENT '1可用 0不可用',
     PRIMARY KEY (`id`)
) ;
